...
impl ColorCode {
    ...
    } // b - background color bit, f - foreground color bit
}     // 00bbbfff
...
const VGA_BUFFER_ADDRESS: isize = 0xb8000;
...
impl fmt::Write for Writer { // implement the "Write" trait
                             // so we can use the "write!" macro
